...
//		conseillerDao.createClient(client2);
		...
		List<Conseiller> conseillers = gerantDao.selectAllConseillers();
		for (Conseiller cons : conseillers){
			System.out.println("conseiller : "+cons.getPrenom()+" "+cons.getNom());
		}
...
//		Virement vir7 = new Virement();
//		vir7.setCompteCrediteur(cc1);
//		vir7.setCompteDebiteur(cc2);
//		vir7.setMontant(300);
//		vir7.setDateExecution(date1);
//		conseillerDao.createVirement(vir7);
//		Virement vir8 = new Virement();
//		vir8.setCompteCrediteur(cc2);
//		vir8.setCompteDebiteur(cc1);
//		vir8.setMontant(100);
//		vir8.setDateExecution(date1);
//		conseillerDao.createVirement(vir8);
//		Virement vir9 = new Virement();
//		vir9.setCompteCrediteur(cc1);
//		vir9.setCompteDebiteur(cc3);
//		vir9.setMontant(300);
//		vir9.setDateExecution(date1);
//		conseillerDao.createVirement(vir9);
//		Virement vir10 = new Virement();
//		vir10.setCompteCrediteur(cc4);
//		vir10.setCompteDebiteur(cc1);
//		vir10.setMontant(200);
//		vir10.setDateExecution(date1);
//		conseillerDao.createVirement(vir10);
//		Virement vir11 = new Virement();
//		vir11.setCompteCrediteur(cc2);
//		vir11.setCompteDebiteur(cc3);
//		vir11.setMontant(100);
//		vir11.setDateExecution(date1);
//		conseillerDao.createVirement(vir11);
//		Virement vir12 = new Virement();
//		vir12.setCompteCrediteur(cc1);
//		vir12.setCompteDebiteur(cc2);
//		vir12.setMontant(20);
//		vir12.setDateExecution(date1);
//		conseillerDao.createVirement(vir12);
//
	}
}
